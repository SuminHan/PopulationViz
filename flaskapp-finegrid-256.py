...
bgdf = gpd.read_file('assets/population_grid_256x256_points_filtered.geojson')

popu_df = pd.read_csv('assets/population_grid_256x256_data_light.csv', index_col=0)
